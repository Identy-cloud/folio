...
export function ContextMenu({ x, y, elementId, onClose }: Props) {
  ...
  const btn = "flex w-full items-center gap-2 px-3 py-1.5 text-xs text-neutral-300 hover:bg-neutral-700 transition-colors focus:bg-neutral-700 focus:outline-none";
    ...
    >
      {el && (
        <>
          ...
          <button
            role="menuitem"
            className="flex w-full items-center gap-2 px-3 py-1.5 text-xs text-red-400 hover:bg-neutral-700 transition-colors focus:bg-neutral-700 focus:outline-none"
