    ...
    <div className="space-y-4">
      ...
      <div className="border border-silver/30 p-4">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-xs text-slate">Idioma</p>
            <p className="mt-0.5 text-[11px] text-steel">Cambia el idioma de la interfaz</p>
          </div>
          <LocaleSelector />
        </div>
      </div>
      <div className="border border-silver/30 p-4">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-xs text-slate">Email semanal de analytics</p>
          ...
          <button
            ...
            className={`relative h-6 w-11 shrink-0 cursor-pointer rounded-full transition-colors ${
              emailDigest ? "bg-accent" : "bg-silver/20"
            }`}
            role="switch"
