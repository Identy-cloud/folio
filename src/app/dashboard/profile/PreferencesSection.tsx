    ...
    <div className="space-y-4">
      ...
      <div className="border border-neutral-800 p-4">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-xs text-neutral-200">Idioma</p>
            <p className="mt-0.5 text-[11px] text-neutral-500">Cambia el idioma de la interfaz</p>
          </div>
          <LocaleSelector />
        </div>
      </div>
      <div className="border border-neutral-800 p-4">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-xs text-neutral-200">Email semanal de analytics</p>
          ...
          <button
            ...
            className={`relative h-6 w-11 shrink-0 cursor-pointer rounded-full transition-colors ${
              emailDigest ? "bg-white" : "bg-neutral-700"
            }`}
            role="switch"
