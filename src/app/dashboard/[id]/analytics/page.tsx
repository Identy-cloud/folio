          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              <div className="rounded border border-neutral-800 p-6 text-center">
                <Eye size={24} className="mx-auto text-neutral-500" />
                <p className="mt-2 font-display text-4xl">{data.totalViews}</p>
                <p className="mt-1 text-xs text-neutral-500 uppercase tracking-wider">Total views</p>
              </div>
              <div className="rounded border border-neutral-800 p-6 text-center">
                <Users size={24} className="mx-auto text-neutral-500" />
                <p className="mt-2 font-display text-4xl">{data.uniqueViewers}</p>
                <p className="mt-1 text-xs text-neutral-500 uppercase tracking-wider">Unique viewers</p>
              </div>
              <div className="rounded border border-neutral-800 p-6 text-center">
                <Timer size={24} className="mx-auto text-neutral-500" />
                <p className="mt-2 font-display text-4xl">{data.avgDuration}s</p>
                <p className="mt-1 text-xs text-neutral-500 uppercase tracking-wider">Avg. duration</p>
              </div>
            </div>
            ...
            {data.viewsBySlide.length > 0 && (
              <div>
                <h2 className="mb-4 text-xs font-medium text-neutral-400 uppercase tracking-wider">Views by slide</h2>
                  ...
                  {data.viewsBySlide.map((s) => {
                    ...
                    return (
                      <div key={s.slideIndex} className="flex items-center gap-3">
                        <span className="w-16 text-right text-sm text-neutral-500">Slide {s.slideIndex + 1}</span>
            ...
            {data.recentViews.length > 0 && (
              <div>
                <h2 className="mb-4 text-xs font-medium text-neutral-400 uppercase tracking-wider">Recent views</h2>
