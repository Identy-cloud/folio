...
export function UsageIndicators() {
  ...
  return (
    <div className="mb-4 flex flex-col gap-3 rounded border border-silver/30 bg-[#FAFAFA] p-3 sm:flex-row sm:items-center sm:gap-6 sm:p-4">
      {presMax !== Infinity && (
        <div className="flex flex-1 flex-col gap-1">
          ...
          <div className="h-1.5 w-full overflow-hidden rounded-full bg-navy/5">
            <div
              className={`h-full rounded-full transition-all ${presPercent >= 90 ? "bg-red-500" : presPercent >= 70 ? "bg-yellow-500" : "bg-navy/30"}`}
      ...
      <div className="flex flex-1 flex-col gap-1">
        ...
        <div className="h-1.5 w-full overflow-hidden rounded-full bg-navy/5">
          <div
            className={`h-full rounded-full transition-all ${storagePercent >= 90 ? "bg-red-500" : storagePercent >= 70 ? "bg-yellow-500" : "bg-navy/30"}`}
      ...
      {!isPaid && (
        <Link
          href="/pricing"
          className="shrink-0 text-xs font-medium tracking-widest text-navy uppercase transition-colors hover:text-accent"
        >
