...
const securityHeaders = [
  ...
  { key: "Permissions-Policy", value: "camera=(), microphone=(self), geolocation=()" },
  {
    ...
    value: [
      ...
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.r2.dev https://*.partykit.io wss://*.partykit.io https://*.sentry.io https://*.posthog.com https://us.i.posthog.com https://us-assets.i.posthog.com https://image.pollinations.ai https://api.anthropic.com",
